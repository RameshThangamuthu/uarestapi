...
public class CassandraUtil {
    ...
    public CassandraClusterFactoryBean cluster() {
        ...
        cluster.setReconnectionPolicy(new ConstantReconnectionPolicy(500000L));
        return cluster;
    ...
    public CassandraSessionFactoryBean session() throws Exception {
        ...
        /*Cluster cluster1 =
        	  ...
        	  cluster1.getConfiguration().getSocketOptions().setReadTimeoutMillis(100000);
        	  
        	  Session session = cluster1.connect(getKeyspaceName());*/
