package com.usageaccounting.util;
...
/*     public <T> T getRateByID(Object id, Class<T> claz) {
   		return cassandraTemplate.selectOneById(claz, id);
    }*/
    
    public <T> T getCreditsByuserID(Object id, Class<T> claz) {
          return cassandraTemplate.selectOneById(claz, id);
    }
    public <T> T onBoardCreditAdjustment(T entity, Class<T> claz) {   
        return (T) cassandraTemplate.update(entity);
    }
	
	public <T> T getApplicationMetrics(Object id, Class<T> claz) {
   		return cassandraTemplate.selectOneById(claz, id);
    }
	

    public <T> List<T> getDataFromRollUp(Select select, Class<T> claz) {
    	//System.out.println("getDataFromRollUp() <"+select.toString()+">");
    	return cassandraTemplate.select(select, claz);
    }
    
    public <T> T getRollUpTableData(Select select, Class<T> claz) {
    	System.out.println("getDataFromRollUp() <"+select.toString()+">");
    	return cassandraTemplate.selectOne(select, claz);
    }
}