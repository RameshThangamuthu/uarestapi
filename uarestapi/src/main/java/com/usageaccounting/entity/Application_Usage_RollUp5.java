...
@Table("Application_Usage_RollUp5")
@Component
public class Application_Usage_RollUp5 {
	 ...
	 * Default Constructor
	 */
	public Application_Usage_RollUp5 () {
		super();
	}
	 ...
	 * @param hour
	 */
	public Application_Usage_RollUp5 (String userId, String appName, String region, String telcoId, String cloudletId, String metric_Type, 
			Date processingDate, String metric_Value, String day_Hour_Min, int flag, int hour) {
		super();
		this.userId = userId;
    ...
    public String toString() {
        return "Application_Usage_RollUp5 [userId=" + userId + ", appName=" + appName + ", region=" + region + ", telcoId=" + telcoId
        		+ ", cloudletId=" + cloudletId + ", metric_Type=" + metric_Type + ", processingDate=" + processingDate
        		+ ", metric_Value=" + metric_Value + ", day_Hour_Min=" + day_Hour_Min + ", flag=" + flag + ", hour=" + hour + "]";
    }
}
